...
const HomePage = () => {
  ...
  const fetchProducts = async (page = 0, filters = {}, sort = '') => {
    ...
    try {
      ...
      //them cac tham so loc khac
      if (filters.minPrice) apiUrl += `&minPrice=${filters.minPrice}`;
      if (filters.maxPrice) apiUrl += `&maxPrice=${filters.maxPrice}`;
    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {[
          { 
            name: 'Áo thun', 
            image: 'https://image.hm.com/assets/hm/e9/0c/e90c297b5b49be36fe399581aac68387f6f8c2bb.jpg?imwidth=1536'
          },
          { 
            name: 'Quần jean', 
            image: 'https://image.hm.com/assets/hm/80/3a/803a90480c4304b1500727ed980c02536d673068.jpg?imwidth=1536'
          },
          { 
            name: 'Váy đầm', 
            image: 'https://image.hm.com/assets/hm/d2/9b/d29bcece15750ac6c14a901180a0d17936281424.jpg?imwidth=1536'
          },
          { 
            name: 'Đồ thể thao', 
            image: 'https://thoitrangbigsize.vn/wp-content/uploads/2024/05/5-21.jpg'
          },
          { 
            name: 'Áo khoác', 
            image: 'https://image.hm.com/assets/hm/2e/11/2e11f46112fddcf2731b6e0f50d4800a3d989388.jpg?imwidth=1536'
          },
          { 
            name: 'Phụ kiện', 
            image: 'https://down-vn.img.susercontent.com/file/7c7813a2ceb01bbd8c364c59b356e2c7'
          }
        ].map((category, index) => (
          <div 
            key={index}
          ...
          >
            <div className="w-16 h-16 mb-3 bg-white rounded-full flex items-center justify-center overflow-hidden">
              <img 
                src={category.image}
                alt={category.name}
                ...
                onError={(e) => {
                  ...
                  e.target.src = `https://placehold.co/40?text=${index + 1}`;
                }}
              />
            </div>
